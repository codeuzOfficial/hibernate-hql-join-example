...
//        fetchJoinExample();
    ...
    public static void crossJoin() {
        ...
        Query query = session.createQuery("SELECT  d From DepartmentEntity d , EmployeeEntity e");
    ...
    public static void innerJoinExample1() {
        StandardServiceRegistry ssr = new StandardServiceRegistryBuilder().configure("hibernate.cfg.xml").build();
        Metadata meta = new MetadataSources(ssr).getMetadataBuilder().build();
        ...
        Query query = session.createQuery("SELECT e From EmployeeEntity e inner join e.department");
    ...
    public static void leftJoinExample() {
        ...
        Query query = session.createQuery("SELECT e From EmployeeEntity e left join e.department");
        List<EmployeeEntity> list = query.list();
        for (EmployeeEntity employee : list) {
            System.out.println(employee);
        }
    ...
    public static void rightJoinExample() {
        StandardServiceRegistry ssr = new StandardServiceRegistryBuilder().configure("hibernate.cfg.xml").build();
        Metadata meta = new MetadataSources(ssr).getMetadataBuilder().build();
        ...
        Query query = session.createQuery("SELECT d From EmployeeEntity e right join e.department d");
        List<DepartmentEntity> list = query.list();
    ...
    public static void leftJoinExample2() {
        StandardServiceRegistry ssr = new StandardServiceRegistryBuilder().configure("hibernate.cfg.xml").build();
        Metadata meta = new MetadataSources(ssr).getMetadataBuilder().build();
